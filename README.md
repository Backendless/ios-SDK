...
> For the instructions for version 3.x of the library, see [Backendless 3.x Guide](https://backendless.com/documentation/users/ios/users_overview.htm /Backendless 3.x Guide")
