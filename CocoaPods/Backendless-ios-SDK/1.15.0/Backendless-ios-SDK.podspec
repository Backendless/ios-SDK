Pod::Spec.new do |s|
  ...
  s.source         = { 
    ...
    :commit => "4b181aaa039210311006e4782b95aff7ddca4de2",
	:tag => '1.15.0'
  }
  ...
  s.xcconfig       =  { 'OTHER_LDFLAGS' => '-ObjC', 'LIBRARY_SEARCH_PATHS' => '"$(SRCROOT)/Pods/Backendless-ios-SDK/SDK/lib/backendless" "$(SRCROOT)/Pods/Backendless-ios-SDK/SDK/lib/CommLibiOS" "$(SRCROOT)/Pods/Backendless-ios-SDK/SDK/lib/MediaLibiOS" "$(SRCROOT)/Pods/Backendless-ios-SDK/SDK/lib/libav-v9.1965/lib"' }
