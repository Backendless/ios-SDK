Pod::Spec.new do |s|
  ...
  s.source         = { 
    ...
    :commit => "34f66281f973896580efe6bff2e6aeb4fdf8005b",
	:tag => '1.18.2'
  }
  ...
  s.xcconfig       =  { 'OTHER_LDFLAGS' => '-ObjC', 'LIBRARY_SEARCH_PATHS' => '"$(SRCROOT)/Pods/Backendless-ios-SDK/SDK/lib/backendless" "$(SRCROOT)/Pods/Backendless-ios-SDK/SDK/lib/CommLibiOS" "$(SRCROOT)/Pods/Backendless-ios-SDK/SDK/lib/MediaLibiOS" "$(SRCROOT)/Pods/Backendless-ios-SDK/SDK/lib/libav-v9.1965/lib"', 'SWIFT_OBJC_BRIDGING_HEADER' => '"$(SRCROOT)/Pods/Backendless-ios-SDK/SDK/lib/backendless/include/Backendless-Bridging-Header.h"' }
